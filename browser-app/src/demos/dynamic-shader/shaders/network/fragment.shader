...
void main(void){
    ...
    float[50] nextWeights = flatMatrix(allWeightsAndBiases, 0, matrixDimensions);
    float[30] nextLayerActivation = matrixMult(nextWeights, matrixDimensions[0], firstLayer);// zfirstWeights * vec3(firstLayer, 1);
